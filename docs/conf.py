...
# -*- coding: utf-8 -*-
#
# django-opt-out documentation build configuration file, created by
...
project = u'Django Opt-out application'
...
version = django_opt_out.__version__
# The full version, including alpha/beta/rc tags.
release = django_opt_out.__version__
...
htmlhelp_basename = 'django_opt_outdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'django-opt-out.tex',
     u'Django Opt-out application Documentation',
