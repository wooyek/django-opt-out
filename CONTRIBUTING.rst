...
Django Opt-out application could always use more documentation, whether as part of the
official Django Opt-out application docs, in docstrings, or even on the web in blog posts,
articles, and such.
...
3. The pull request should work for Python versions mentioned in tox.ini file. Check
   https://travis-ci.org/wooyek/django-opt-out/pull_requests
